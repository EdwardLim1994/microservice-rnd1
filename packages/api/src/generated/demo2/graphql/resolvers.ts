...
export type FederationReferenceTypes = ResolversObject<{
  Demo1: { __typename: 'Demo1' } & GraphQLRecursivePick<
    FederationTypes['Demo1'],
    { id: true }
  >;
  Demo2: { __typename: 'Demo2' } & GraphQLRecursivePick<
    FederationTypes['Demo2'],
    { id: true }
  >;
}>;
...
export type Demo1Resolvers<
  ContextType = Demo2ContextType,
  ParentType extends
    ResolversParentTypes['Demo1'] = ResolversParentTypes['Demo1'],
  FederationReferenceType extends
    FederationReferenceTypes['Demo1'] = FederationReferenceTypes['Demo1'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['Demo1']> | FederationReferenceType,
    FederationReferenceType,
    ContextType
  >;
  demo2?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Demo2']>>>,
    ParentType,
    ContextType
  >;
}>;

export type Demo2Resolvers<
  ContextType = Demo2ContextType,
  ParentType extends
    ResolversParentTypes['Demo2'] = ResolversParentTypes['Demo2'],
  FederationReferenceType extends
    FederationReferenceTypes['Demo2'] = FederationReferenceTypes['Demo2'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['Demo2']> | FederationReferenceType,
    FederationReferenceType,
    ContextType
  >;
