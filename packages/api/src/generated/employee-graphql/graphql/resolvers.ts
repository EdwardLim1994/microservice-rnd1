...
export type EmployeeResolvers<
  ContextType = EmployeeGraphqlContextType,
  ParentType extends
...
export type EmployeeListResultResolvers<
  ContextType = EmployeeGraphqlContextType,
  ParentType extends
    ResolversParentTypes['EmployeeListResult'] = ResolversParentTypes['EmployeeListResult'],
> = ResolversObject<{
  employees?: Resolver<
...
> = ResolversObject<{
  ...
  >;
  employees?: Resolver<
    ResolversTypes['EmployeeListResult'],
    ParentType,
    ContextType,
...
export type Resolvers<ContextType = EmployeeGraphqlContextType> =
  ResolversObject<{
