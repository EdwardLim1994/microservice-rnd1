...
> = ResolversObject<{
  reviewLeave?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationReviewLeaveArgs, 'input'>
  >;
...
> = ResolversObject<{
  leaveRequests?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryLeaveRequestsArgs, 'employeeId'>
  >;
  pendingLeaveRequestsForSupervisor?: Resolver<
    Array<ResolversTypes['LeaveRequest']>,
    ParentType,
    ContextType,
    RequireFields<QueryPendingLeaveRequestsForSupervisorArgs, 'supervisorId'>
  >;
}>;
