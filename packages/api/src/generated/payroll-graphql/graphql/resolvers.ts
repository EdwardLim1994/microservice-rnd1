...
export type FederationReferenceTypes = ResolversObject<{
  PayrollRecord: { __typename: 'PayrollRecord' } & GraphQLRecursivePick<
    FederationTypes['PayrollRecord'],
    { id: true }
  >;
}>;
...
export type PayrollRecordResolvers<
  ContextType = PayrollGraphqlContextType,
  ParentType extends
    ResolversParentTypes['PayrollRecord'] = ResolversParentTypes['PayrollRecord'],
  FederationReferenceType extends
    FederationReferenceTypes['PayrollRecord'] = FederationReferenceTypes['PayrollRecord'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['PayrollRecord']> | FederationReferenceType,
...
export type PayrollRecordListResultResolvers<
  ContextType = PayrollGraphqlContextType,
  ParentType extends
    ResolversParentTypes['PayrollRecordListResult'] = ResolversParentTypes['PayrollRecordListResult'],
> = ResolversObject<{
  records?: Resolver<
    Array<ResolversTypes['PayrollRecord']>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  myPayrollRecords?: Resolver<
    ResolversTypes['PayrollRecordListResult'],
    ParentType,
    ContextType,
    Partial<QueryMyPayrollRecordsArgs>
  >;
  payrollPdfUrl?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<QueryPayrollPdfUrlArgs, 'payrollRecordId'>
  >;
}>;

export type Resolvers<ContextType = PayrollGraphqlContextType> =
  ResolversObject<{
