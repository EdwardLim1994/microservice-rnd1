...
export type FederationReferenceTypes = ResolversObject<{
  LeaveRequest: { __typename: 'LeaveRequest' } & GraphQLRecursivePick<
    FederationTypes['LeaveRequest'],
    { id: true }
  >;
}>;
...
export type LeaveBalanceResolvers<
  ContextType = LeaveGraphqlContextType,
  ParentType extends
    ResolversParentTypes['LeaveBalance'] = ResolversParentTypes['LeaveBalance'],
> = ResolversObject<{
...
export type LeaveRequestResolvers<
  ContextType = LeaveGraphqlContextType,
  ParentType extends
    ResolversParentTypes['LeaveRequest'] = ResolversParentTypes['LeaveRequest'],
  FederationReferenceType extends
    FederationReferenceTypes['LeaveRequest'] = FederationReferenceTypes['LeaveRequest'],
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['LeaveRequest']> | FederationReferenceType,
...
export type LeaveRequestListResultResolvers<
  ContextType = LeaveGraphqlContextType,
  ParentType extends
    ResolversParentTypes['LeaveRequestListResult'] = ResolversParentTypes['LeaveRequestListResult'],
> = ResolversObject<{
  leaveRequests?: Resolver<
    Array<ResolversTypes['LeaveRequest']>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  reviewLeave?: Resolver<
    ResolversTypes['LeaveRequest'],
    ParentType,
    ContextType,
    RequireFields<MutationReviewLeaveArgs, 'decision' | 'id'>
  >;
  submitLeave?: Resolver<
    ResolversTypes['SubmitLeaveResult'],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitLeaveArgs, 'input'>
  >;
}>;
...
> = ResolversObject<{
  myLeaveBalance?: Resolver<
    ResolversTypes['LeaveBalance'],
    ParentType,
    ContextType
  >;
  myLeaveRequests?: Resolver<
    ResolversTypes['LeaveRequestListResult'],
    ParentType,
    ContextType,
    Partial<QueryMyLeaveRequestsArgs>
  >;
  pendingApprovals?: Resolver<
    ResolversTypes['LeaveRequestListResult'],
    ParentType,
    ContextType,
    Partial<QueryPendingApprovalsArgs>
  >;
}>;

export type SubmitLeaveResultResolvers<
  ContextType = LeaveGraphqlContextType,
  ParentType extends
    ResolversParentTypes['SubmitLeaveResult'] = ResolversParentTypes['SubmitLeaveResult'],
> = ResolversObject<{
  balance?: Resolver<ResolversTypes['LeaveBalance'], ParentType, ContextType>;
  leaveRequest?: Resolver<
    ResolversTypes['LeaveRequest'],
    ParentType,
    ContextType
  >;
